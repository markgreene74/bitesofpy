# https://codechalleng.es/bites/204/
...
ONE_MIN = 0.006
FIVE_MIN = ONE_MIN * 0.0005
TWENTY_FIVE_MIN = ONE_MIN * 0.0025
THIRTY_MIN = ONE_MIN * 0.003
HOUR = ONE_MIN * 0.06
CURRENT_SESSION = 1
...
async def lunch_time(delay: Union[float, int]) -> None:
    """Lunch time
...
async def work_time(delay: Union[float, int], loop: int) -> None:
    """Work time
...
async def session(
    work_length: Union[float, int] = TWENTY_FIVE_MIN,
    short_break_length: Union[float, int] = FIVE_MIN,
    long_break_length: Union[float, int] = THIRTY_MIN,
) -> None:
    """Session
...
async def main(
    ...
    short_break_length: Union[float, int] = FIVE_MIN,
    long_break_length: Union[float, int] = THIRTY_MIN,
    lunch_length: Union[float, int] = HOUR,
) -> None:
    """Main entry point
