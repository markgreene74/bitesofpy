...
def make_character_index(text=text, characters=CHARACTERS):
    ...
    # iterate all of the characters
    # use the helper to normalize transform each character
    # into to a list (normalize)
    for i, line in enumerate(split_text):
        for character in characters:
            aliases = make_a_list(character)
            name = aliases[0].lower()
